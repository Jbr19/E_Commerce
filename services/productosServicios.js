function crearNuevaLinea(nombre, precio, image, id) {
    ...
    <a class="productos__item__btn" data-btn-verProd>Ver Producto</a>`;
...
const crearLineaAdmin = (image,nombre,precio,id) => {
    ...
    <div class="productos__admin__tools">
        <img class="productos__admin__delete" src="./img/banner_logos_iconos/Delete.svg" alt="Eliminar title="Eliminar" data-eliminar id="${id}">
        <img data-editar class="productos__admin__edit" src="./img/banner_logos_iconos/Edit.svg" alt="Editar" title="Editar">
    </div> 
